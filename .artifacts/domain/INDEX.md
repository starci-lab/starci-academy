...
> **ARTIFACT, KHÔNG PHẢI CANON.** Đây là ảnh chụp nghiệp vụ **rút từ code**, nên nó **có hạn
> sử dụng**: code đổi thì nó lạc hậu, và lúc đó **rút lại chứ không sửa tay**.
>
> Trả lời đúng một câu: **màn này phục vụ THỰC THỂ nào, thực thể đó có những TRẠNG THÁI nào.**
>
> Ranh giới, theo đúng luật ở [`../README.md`](../README.md): **canon là thứ thầy QUYẾT**
> (không đổi khi code đổi, sống ở `.claude/fe/principles/`) · **artifact là thứ RÚT TỪ code**
> (đổi theo code, sống ở đây).
> 🧭 Phép thử một câu: **file này có hạn sử dụng không?** Có ⇒ artifact, không được ghi vào `.claude/`.
>
> Dựng 2026-07-29 vì nghiệp vụ StarCi trước đó **chưa từng có nhà**: nhánh sáng-tạo của
> `story-create` phải bắt thầy mô tả lại nghiệp vụ mỗi lần dựng một màn, còn nhánh đọc-source
> thì không có gì để đối chiếu xem màn có phục vụ đúng việc không.
>
> ⚠️ Bộ này ban đầu bị ghi nhầm vào `.claude/fe/domain/`, thầy bắt được và chuyển về đây cùng
> ngày. Neo cho lần sau: **định ghi một file có ngày hết hạn vào `.claude/` thì dừng lại.**
...
📌 **Khi thầy chốt một chỗ trong bảng trên, PHÁN QUYẾT đó là CANON, không phải artifact** —
nó là thứ thầy quyết, không đổi khi code đổi. Ghi vào `.claude/fe/principles/<trục>` nếu nó
thành một luật chung, và chỉ để lại ở đây một dòng trỏ sang. Bảng này chỉ giữ phần **quan sát
được**, không giữ phần **đã quyết**.
