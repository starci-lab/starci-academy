            ...
            <CardContent className={cn("flex flex-col gap-3", contentClassName)}>
                {hasHeader ? (
                    <div className="flex items-center justify-between gap-3 border-b border-separator pb-3">
                            ...
                            {icon ? (
                                isSkeleton ? (
                                    <Skeleton
                                        ...
                                        anatPart={showAnatomy ? "Icon" : undefined}
                                    />
                                ) : (
                                    <span
                            ...
                            {title ? (
                                isSkeleton ? (
                                    <Skeleton.Typography
                                        type="body"
                                        width="1/2"
                                        anatPart={showAnatomy ? "Title" : undefined}
                                    />
                                ) : (
                                    <span
                        ...
                        {action ? (
                            isSkeleton ? (
                                <Skeleton.Button anatPart={showAnatomy ? "Action" : undefined} />
                            ) : (
                ...
                {isSkeleton ? (
                    <Skeleton.Paragraph lines={3} anatPart={showAnatomy ? "Body" : undefined} />
                ) : showAnatomy ? (
