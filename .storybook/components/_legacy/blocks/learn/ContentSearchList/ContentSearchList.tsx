        ...
        >
                            ...
                            content: (
                                <div className="flex items-center gap-2">
                                    <div className="flex min-w-0 flex-1 flex-col gap-0">
                                        <Typography size="sm" isSkeleton className="w-2/3" anatPart={showAnatomy ? "Skeleton" : undefined} />
                                        <Typography size="xs" isSkeleton className="w-1/2" anatPart={showAnatomy ? "Skeleton" : undefined} />
                                    </div>
                                    <HeroSkeleton className="size-4 shrink-0 rounded" data-anat-part={showAnatomy ? "Skeleton" : undefined} />
                                </div>
                            ),
                        }))}
                    />
            ...
            >
                {isIdle ? (
                    ...
                    // WRAPPER frame (`.Base flushContent` = same `overflow-hidden` + surface
