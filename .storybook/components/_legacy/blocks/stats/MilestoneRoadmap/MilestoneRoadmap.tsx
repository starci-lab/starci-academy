 ...
 * `@/components/blocks/stats/MilestoneRoadmap`. Authored in Storybook (not
 ...
 * Pure + props-only; the block owns all the dot/connector styling.
 */
export const MilestoneRoadmap = ({ milestones, className, showAnatomy }: MilestoneRoadmapProps) => {
    return (
                ...
                return (
                    <React.Fragment key={`${milestone.title}-${index}`}>
                        {index > 0 ? (
                            <span
                                aria-hidden
                                className="h-0.5 min-w-3 flex-1 bg-default/60"
                        ...
                        <span
                            ...
                            aria-hidden
                            data-anat-part={showAnatomy ? "Node" : undefined}
                            className={cn(
