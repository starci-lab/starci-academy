...
export const CourseCard = ({
    ...
    const secondaryAction = isEnrolled ? (
        ...
        <Button
            ...
            className="flex-1"
            anatPart={showAnatomy ? secondaryButtonAnatPart : undefined}
        >
            {T.viewCourse}
        </Button>
    ) : action
                ...
                <Card className={cn("overflow-hidden rounded-3xl", className)}>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative hidden aspect-video w-36 shrink-0 overflow-hidden rounded-2xl @app-sm:block">
                            <HeroSkeleton className="size-full" data-anat-part={showAnatomy ? "Skeleton.Cover" : undefined} />
                        </div>
                        {/* title + users-meta, then a one-line description */}
                        <div className="flex min-w-0 flex-1 flex-col gap-1">
                            <div className="flex items-center gap-2">
                                <Typography size="base" isSkeleton className="w-1/2" anatPart={showAnatomy ? "Skeleton.Title" : undefined} />
                        ...
                        <div className="flex shrink-0 flex-col items-end gap-2">
                            <Typography size="base" isSkeleton className="w-20" anatPart={showAnatomy ? "Skeleton.Price" : undefined} />
                            <div className="flex w-full items-center gap-2">
                                <Button isSkeleton className="flex-1" anatPart={showAnatomy ? "Skeleton" : undefined} />
                                <Button isSkeleton className="flex-1" anatPart={showAnatomy ? "Skeleton" : undefined} />
                            </div>
                        </div>
                    </div>
        ...
        return (
            <Card className={cn("flex flex-col overflow-hidden rounded-3xl", className)} data-anat-part={showAnatomy ? "Card" : undefined}>
                <Card.Content className="flex flex-col gap-3" data-anat-part={showAnatomy ? "Card.Content" : undefined}>
                    ...
                    <HeroSkeleton className="aspect-video w-full rounded-2xl" data-anat-part={showAnatomy ? "Skeleton.Cover" : undefined} />
                ...
                <Card.Footer className="mt-auto flex flex-col items-start gap-2" data-anat-part={showAnatomy ? "Card.Footer" : undefined}>
                    {/* price line */}
                    <Typography size="base" isSkeleton className="w-1/3" anatPart={showAnatomy ? "Skeleton.Price" : undefined} />
                    ...
                    <div className="flex min-w-0 flex-1 flex-col gap-1">
                        <div className="flex items-center gap-2">
                            <HeroTypography
                                ...
                                weight="bold"
                                truncate
                                data-anat-part={showAnatomy ? "HeroTypography.Title" : undefined}
                            >
                                {course.title}
                            </HeroTypography>
                            {course.enrollmentCount > 0 ? (
                                <div className="flex shrink-0 items-center gap-1 text-muted">
                                    ...
                                    <HeroTypography
                                        type="body-xs"
                                        color="muted"
                                        data-anat-part={showAnatomy ? "HeroTypography.Learners" : undefined}
                                    >
                        ...
                        <HeroTypography
                            ...
                            data-anat-part={showAnatomy ? "HeroTypography.Description" : undefined}
                        >
                            {course.description}
                        </HeroTypography>
                    </div>
                    ...
                    {showCover ? (
                        ...
                        <div className="flex size-full items-center justify-center bg-gradient-to-br from-accent/25 to-accent/5 p-4">
                            ...
                            <HeroTypography
                                ...
                                align="center"
                                className="ml-2"
                                data-anat-part={showAnatomy ? "HeroTypography.FallbackTitle" : undefined}
                            >
                                {course.title}
                            </HeroTypography>
                        </div>
                    ...
                    {topValueProps.length > 0 ? (
                        ...
                        <SurfaceCardCrossList
                            ...
                            items={topValueProps.map((valueProp, index) => ({
                                ...
                                text: <HeroTypography type="body-sm">{valueProp.text}</HeroTypography>,
                            }))}
                        />
                    ) : null}
                </div>
            ...
            <Card.Footer className="mt-auto flex flex-col items-start gap-2" data-anat-part={showAnatomy ? "Card.Footer" : undefined}>
                ...
                {formattedPriceUsd != null ? (
                    <HeroTypography
                        type="body-xs"
                        color="muted"
                        data-anat-part={showAnatomy ? "HeroTypography.Usd" : undefined}
                    >
