            ...
            <Card className={cn("rounded-3xl", className)} data-anat-part={showAnatomy ? "Card" : undefined}>
                <Card.Content className="flex h-full flex-col gap-2">
                    ...
                    <div className="flex items-center justify-between gap-2 pt-1">
                        <Typography size="xs" isSkeleton className="w-1/4" anatPart={showAnatomy ? "Skeleton" : undefined} />
                        <Button isSkeleton className="w-24" anatPart={showAnatomy ? "Skeleton" : undefined} />
                    </div>
                </Card.Content>
            </Card>
        )
