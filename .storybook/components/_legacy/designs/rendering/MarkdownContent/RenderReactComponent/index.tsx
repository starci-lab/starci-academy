...
import { heroUiMdxComponents } from "@sb-components/_legacy/designs/rendering/MarkdownContent/mdxComponents"
import type { WithClassNames } from "@sb-components/_legacy/designs/rendering/MarkdownContent/local-types"

/**
 * STORYBOOK-LOCAL DESIGN SPEC — faithful port of the src `RenderReactComponent`
 ...
 * and renders it with the full HeroUI map ({@link heroUiMdxComponents}). `"use client"` for the
