...
export interface ExtendedTabsProps {
     ...
     *
     * §12b exception: `ExtendedTabs` is a true atom-WRAPPER, not a content atom —
     * like `Tooltip` wrapping its trigger or `Menu` wrapping its trigger, this
     * `children` is the CALLER's own compound tree (`Tabs.*` parts), not text/data
     * content owned by this atom. There is no data-prop shape that could carry an
     * arbitrary `Tabs.ListContainer > Tabs.List > Tabs.Tab` tree, so `children` is
     * the correct (and only) API here.
     */
    children: ReactNode
    /**
...
/** `ExtendedTabs.*` — StarCi standard tab strip. */
export const ExtendedTabs = Object.assign(ExtendedTabsBase, {
    Base: ExtendedTabsBase,
})
