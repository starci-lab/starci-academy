 ...
 */
const FlexWrapButtonRadioBase = <T extends string>(props: FlexWrapButtonRadioProps<T>) => {
...
/** `FlexWrapButtonRadio.*` — single/multi-select toggle-button flex-wrap row. */
export const FlexWrapButtonRadio = Object.assign(FlexWrapButtonRadioBase, {
    Base: FlexWrapButtonRadioBase,
})
