 ...
 */
const SelectableCardGroupBase = <T extends string>({
    items,
    value,
    onChange,
    ariaLabel,
...
/** `SelectableCardGroup.*` — single-select group of surface cards. */
export const SelectableCardGroup = Object.assign(SelectableCardGroupBase, {
    Base: SelectableCardGroupBase,
})
