 ...
 * nhập vào đây làm `Tabs.Extended` — cả hai member cùng bọc HeroUI `Tabs`, tách
 ...
 *   • `Tabs.Base`     → ./TabsBase     — data-driven, `items` (§12b sạch).
 *   • `Tabs.Extended` → ./TabsExtended — `children` thô (§12b nợ, xem header đó).
 *
 * Call-site bên ngoài dùng `Tabs.Base` giữ nguyên đường import cũ
