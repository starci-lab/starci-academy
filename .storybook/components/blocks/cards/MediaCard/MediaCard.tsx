    ...
    if (isSkeleton) {
        return (
            <Card className={cn("gap-0 overflow-hidden p-0", className)}>
                <div
                    data-anat-part={showAnatomy ? "Skeleton.Cover" : undefined}
                ...
                <CardContent className="flex flex-col gap-3 p-3">
                    ...
                    <Skeleton.Typography type="body" width="2/3" anatPart={showAnatomy ? "Skeleton.Typography" : undefined} />
                    ...
                    <span className="flex flex-col gap-2">
                        <Skeleton.Typography type="body-sm" width="full" anatPart={showAnatomy ? "Skeleton.Typography" : undefined} />
    ...
    const card = (
        ...
        <Card className={cn("gap-0 overflow-hidden p-0", !interactive && className)}>
            ...
            <div
                ...
                className="aspect-video w-full shrink-0 overflow-hidden [&_img]:block [&_img]:size-full [&_img]:object-cover"
            >
                {coverNode}
            </div>
            <CardContent className="flex flex-col gap-3 p-3">
                <Typography weight="medium" data-anat-part={showAnatomy ? "Typography.Title" : undefined}>
                    {title}
                </Typography>
                ...
                {footer ? <div data-anat-part={showAnatomy ? "Footer" : undefined}>{footer}</div> : null}
            </CardContent>
        </Card>
    )
