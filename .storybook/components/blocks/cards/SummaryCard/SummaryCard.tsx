        ...
        return (
            ...
            >
                <div className="flex items-center justify-between gap-3">
                    <Skeleton className="size-6 rounded-lg" anatPart={showAnatomy ? "Skeleton" : undefined} />
                    <Skeleton className="size-5 rounded" anatPart={showAnatomy ? "Skeleton" : undefined} />
                </div>
        ...
        >
            <div className="flex items-center justify-between gap-3">
                <span
                    ...
                    className="text-accent-soft-foreground [&_svg]:size-6"
                >
                    {icon}
                </span>
                <CaretRightIcon
 ...
 */
const SummaryCardGroup = ({ items, isSkeleton = false, showAnatomy = false, className }: SummaryCardGroupProps) => (
    <div className={cn("flex flex-wrap gap-3", className)}>
        {items.map((item, index) => (
            <div key={index} className="basis-56 grow">
                <SummaryCardBase {...item} isSkeleton={isSkeleton} showAnatomy={showAnatomy} />
            </div>
        ))}
    </div>
)
