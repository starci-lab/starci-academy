...
export interface CodeConsoleProps {
    ...
    className?: string
    /** Storybook-only: badge this block's OWN direct parts for a BlockAnatomy panel. */
    showAnatomy?: boolean
}
...
export const CodeConsole = ({
    ...
    return (
        <div className={cn("flex min-h-0 flex-col border-t border-default bg-surface", className)}>
            <div className="px-3 pt-1" data-anat-part={showAnatomy ? "Tabs" : undefined}>
            ...
            <div className="min-h-0 flex-1 overflow-auto p-3" data-anat-part={showAnatomy ? "Panel" : undefined}>
                {active?.content}
            </div>

            <div className="flex items-center justify-between gap-3 border-t border-default px-3 py-2" data-anat-part={showAnatomy ? "Footer" : undefined}>
