...
export interface DatePickerProps {
    ...
    className?: string
    /**
     * Storybook-only: when true the block emits `data-anat-part` markers on its
     * direct parts (`FieldShell` / `DateField`) so the anatomy panel can anchor
     * badges. No effect on layout.
     */
    showAnatomy?: boolean
}
...
export const DatePicker = ({
    ...
    return (
        // FieldShell (../FieldShell/FieldShell.tsx) doesn't accept an anatPart/data-*
        // prop — wrap it in a plain marker div so the panel can badge it as ONE node
        // without touching that shared foundation file.
        <div data-anat-part={showAnatomy ? "FieldShell" : undefined}>
            <FieldShell
                label={label}
            ...
            >
                ...
                <div className="contents" data-anat-part={showAnatomy ? "DateField" : undefined}>
                    <HeroDatePicker
                        id={id}
