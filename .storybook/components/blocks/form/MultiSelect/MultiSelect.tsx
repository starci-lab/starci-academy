...
export interface MultiSelectProps {
    ...
    className?: string
    /**
     * When `true`, each composed part (FieldShell / chosen-chips row / combo
     * box) emits `data-anat-part="<name>"` so a BlockAnatomy panel can badge it
        ...
        <div data-anat-part={showAnatomy ? "FieldShell" : undefined}>
            ...
            >
                <div className="flex flex-col gap-2">
                    {chosen.length > 0 ? (
                        <div
                            data-anat-part={showAnatomy ? "ChosenChips" : undefined}
                    ...
                    <div data-anat-part={showAnatomy ? "ComboBox" : undefined}>
                        <HeroMultiSelect
