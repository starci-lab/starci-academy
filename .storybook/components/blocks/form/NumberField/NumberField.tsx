...
export interface NumberFieldProps {
    ...
    className?: string
    /**
     * Dev/spec: tag this field's own direct parts (the FieldShell scaffold + the
     * stepper Group) so a BlockAnatomy panel can badge them.
     */
    showAnatomy?: boolean
}
        ...
        <div data-anat-part={showAnatomy ? "FieldShell" : undefined}>
            ...
            >
                ...
                <HeroNumberField
                    ...
                    fullWidth
                >
                    <div data-anat-part={showAnatomy ? "Group" : undefined}>
