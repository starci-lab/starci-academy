...
export interface SwitchFieldProps {
    ...
    className?: string
    /** When on, emit `data-anat-part` on this field's own direct sub-parts (FieldShell shell · Switch · Label) so a `BlockAnatomy` panel can badge them. */
    showAnatomy?: boolean
}
    ...
    return (
        <div data-anat-part={showAnatomy ? "FieldShell" : undefined}>
            <FieldShell
                ...
                skeletonControl={<Skeleton.Switch anatPart={showAnatomy ? "Skeleton.Switch" : undefined} />}
                id={id}
                className={className}
            >
