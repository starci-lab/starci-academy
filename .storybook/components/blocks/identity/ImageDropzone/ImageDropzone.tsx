 ...
 */
export const ImageDropzone = ({ onFile, label, hint, icon, className, showAnatomy = false }: ImageDropzoneProps) => {
    ...
    return (
        ...
        >
            ...
            {hint ? (
                <Typography type="body-xs" color="muted" align="center" data-anat-part={showAnatomy ? "Hint" : undefined}>
                    {hint}
                </Typography>
            ) : null}
        </div>
