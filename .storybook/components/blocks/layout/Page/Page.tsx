        ...
        <div className={cn("flex flex-col gap-3", className)}>
            ...
            <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex min-w-0 flex-col gap-2">
                    {size === "compact" ? (
                        <Typography type="body" weight="bold" data-anat-part={showAnatomy ? "Title" : undefined}>{title}</Typography>
                    ) : (
                        <Typography.Heading level={3} weight="bold" data-anat-part={showAnatomy ? "Title" : undefined}>{title}</Typography.Heading>
                    )}
                    {description ? (
