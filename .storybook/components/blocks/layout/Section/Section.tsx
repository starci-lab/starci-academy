...
import { GAP_CLASS, type SpaceScale } from "../../_spacing"
...
/** level → the `Typography.*` member each line uses. One table, no call-site choice. */
const TITLE_TYPE: Record<SectionLevel, typeof Typography.Lg> = {
    1: Typography.Lg,
    2: Typography.Base,
    3: Typography.Sm,
}
const DESCRIPTION_TYPE: Record<SectionLevel, typeof Typography.Sm> = {
    1: Typography.Sm,
    2: Typography.Sm,
    3: Typography.Xs,
}
const EYEBROW_TYPE: Record<SectionLevel, typeof Typography.Xs> = {
    1: Typography.Sm,
    2: Typography.Xs,
    3: Typography.Xs,
}
...
const Header = ({
    ...
    const Title = TITLE_TYPE[level]
    const Description = DESCRIPTION_TYPE[level]
    const Eyebrow = EYEBROW_TYPE[level]
    return (
