    ...
    if (isSkeleton) {
        return (
            <div className={cn("flex items-center gap-3 py-2", className)}>
                <Skeleton className="size-5 shrink-0 rounded-full" data-anat-part={showAnatomy ? "Skeleton.Icon" : undefined} />
                <Skeleton.Typography type="body-sm" width="1/2" data-anat-part={showAnatomy ? "Skeleton.Typography" : undefined} />
            </div>
        )
    }
