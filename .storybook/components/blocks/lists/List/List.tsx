...
import { Label, Switch, Typography, cn } from "@heroui/react"
...
const RowSkeleton = ({
    ...
    <div className={cn("flex min-w-0 items-center gap-3 py-2", className)}>
        {hasLeading ? (
            <Skeleton className="size-5 shrink-0 rounded" anatPart={showAnatomy ? "Leading" : undefined} />
        ) : null}
    ...
    <div className={cn("flex min-w-0 items-center gap-2", className)} data-anat-part={anatPart}>
        ...
        {items.length > 0 ? (
            <Typography
                ...
                truncate
                className="min-w-0"
                data-anat-part={showAnatomy ? "Meta" : undefined}
            >
        ...
        return (
            <div className={cn("flex items-center gap-3", className)}>
                ...
                <TitledText
                    ...
                    anatPart={showAnatomy ? "TitledText" : undefined}
                />
                <Skeleton.Switch className="shrink-0" anatPart={showAnatomy ? "Switch" : undefined} />
            </div>
        )
    }
    return (
