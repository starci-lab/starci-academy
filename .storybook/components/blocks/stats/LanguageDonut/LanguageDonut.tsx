...
export interface LanguageDonutProps {
    ...
    className?: string
    /**
     * Dev/spec: tag this donut's own direct parts (`Donut` / `Legend`) so a
    ...
    return (
        <div className={cn("flex flex-col items-center gap-6 @app-sm:flex-row", className)}>
            ...
            <div
                ...
                data-anat-part={showAnatomy ? "Donut" : undefined}
            >
            ...
            <div className="flex w-full flex-col gap-3" data-anat-part={showAnatomy ? "Legend" : undefined}>
                {items.map((item) => (
