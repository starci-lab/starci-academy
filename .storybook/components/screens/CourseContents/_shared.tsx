...
export const PARTS: Array<AnatomyNode> = [
    ...
    },
    {
        ...
        storyId: "blocks-learn-coursebrief-coursebrief--full",
    },
    ...
    { name: "CourseTeamGate", tier: "block", role: "GitHub-team warning — shows for an enrolled viewer who is not in the team yet", state: "warning", storyId: "blocks-learn-courseteamgate-courseteamgate--warning" },
    ...
    { name: "TrialConversionStrip", tier: "block", role: "trial→enroll conversion strip; the screen drops it entirely once purchased", storyId: "blocks-commerce-trialconversionstrip-trialconversionstrip--default" },
    ...
    { name: "ContinueLearning", tier: "block", role: "resume where you left off — the block writes the copy from NUMBERS (lessons read · challenges); the design only draws", storyId: "blocks-learn-continuelearning-continuelearning--default" },
    { name: "LearnNudges", tier: "block", role: "what to do today — cards due · mock interview · rank. The screen passes `kind` (ENUM); the block picks the icon (§14b)", storyId: "blocks-learn-learnnudges-learnnudges--nudges" },
    { name: "KeepGoingPath", tier: "block", role: "lessons of the current module — bordered SurfaceCardList; each row: state icon · title · reading time · difficulty chip · lock icon", storyId: "blocks-learn-keepgoingpath-keepgoingpath--path" },
