    ...
    return (
        <div>
            <AsyncContent
                ...
                skeleton={() => <Grid items={tiles} columns={{ base: 1, sm: 2, lg: 3 }} gap={4} pattern="sibling-stack" />}
                ...
                content={() => <Grid items={tiles} columns={{ base: 1, sm: 2, lg: 3 }} gap={4} pattern="sibling-stack" />}
            />
        </div>
    )
}
