...
const meta: Meta<typeof ContinueCard> = {
    title: "Legacy/Design/Cards/ContinueCard/Hero/No progress",
...
const LOADING_PARTS: Array<AnatomyNode> = [
    {
        ...
        children: [
            { name: "Skeleton", tier: "primitive", role: "mirror tiêu đề (body, 2/3)", state: "skeleton" },
            { name: "Skeleton", tier: "primitive", role: "mirror meta (body-xs, 1/2)", state: "skeleton" },
            { name: "Skeleton", tier: "primitive", role: "mirror CTA chip", state: "skeleton" },
        ],
    },
]
