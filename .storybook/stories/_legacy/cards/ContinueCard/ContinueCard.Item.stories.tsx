...
const meta: Meta<typeof ContinueCard> = {
    title: "Legacy/Design/Cards/ContinueCard/Item",
...
const LOADING_PARTS: Array<AnatomyNode> = [
    {
        ...
        children: [
            { name: "Skeleton.Title", tier: "primitive", role: "mirror dòng tiêu đề (width 2/3)", state: "skeleton" },
            { name: "Skeleton.Subtitle", tier: "primitive", role: "mirror dòng phụ đề (width 1/3)", state: "skeleton" },
            { name: "Skeleton.Cta", tier: "primitive", role: "mirror hàng CTA (width 1/4)", state: "skeleton" },
        ],
    },
]
                ...
                <div className="w-80">
                    <SectionCard anatPart="SectionCard" contentClassName="flex flex-col gap-3">
                        <div className="flex flex-col gap-2">
                            <Typography size="base" isSkeleton className="w-2/3" anatPart="Skeleton.Title" />
                            <Typography size="xs" isSkeleton className="w-1/3" anatPart="Skeleton.Subtitle" />
                        </div>
                        <Typography size="sm" isSkeleton className="w-1/4" anatPart="Skeleton.Cta" />
                    </SectionCard>
                </div>
            </BlockAnatomy>,
        ),
