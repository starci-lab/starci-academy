...
import { HostPlatformChip, VideoHostPlatform } from "@sb-components/_legacy/designs/chips/HostPlatformChip/HostPlatformChip"

const meta: Meta<typeof HostPlatformChip> = {
    title: "Legacy/Design/Chips/HostPlatformChip",
