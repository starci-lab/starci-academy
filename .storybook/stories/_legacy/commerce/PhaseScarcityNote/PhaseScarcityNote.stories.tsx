...
const meta: Meta<typeof PhaseScarcityNote> = {
    title: "Legacy/Design/Commerce/PhaseScarcityNote",
...
const FULL_PARTS: Array<AnatomyNode> = [
    { name: "WarningCircleIcon", tier: "composite", role: "icon cảnh báo khan hiếm suất", state: "warning" },
    { name: "SeatCountLine", tier: "composite", role: "span \"Còn N suất giá {phase}\"" },
    { name: "Separator", tier: "composite", role: "span \"·\" ngăn cách (aria-hidden, trang trí) — chỉ hiện khi có giá kế tiếp" },
    { name: "PriceRiseClause", tier: "composite", role: "span \"giá tăng lên {X}₫ sau đó\" — chỉ hiện khi có giá kế tiếp" },
]

// SEATS-ONLY shape: nextPhasePriceVnd null → the price-rise clause is ABSENT.
const SEATS_ONLY_PARTS: Array<AnatomyNode> = [
    { name: "WarningCircleIcon", tier: "composite", role: "icon cảnh báo khan hiếm suất", state: "warning" },
    { name: "SeatCountLine", tier: "composite", role: "câu \"Còn N suất giá {phase}\"" },
]
