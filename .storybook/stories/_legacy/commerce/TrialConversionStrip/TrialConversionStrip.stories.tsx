...
import { TrialConversionStrip, type TrialConversionStripPrice } from "@sb-components/_legacy/blocks/commerce/TrialConversionStrip/TrialConversionStrip"
...
const meta: Meta<typeof TrialConversionStrip> = {
    title: "Legacy/Block/Commerce/TrialConversionStrip",
...
const LOADING_PARTS: Array<AnatomyNode> = [
    ...HEADER_PARTS,
    { name: "Skeleton.Price", tier: "design", role: "mirror dòng giá (h4, 1/3 width)" },
    { name: "Skeleton.Seats", tier: "design", role: "mirror dòng suất (body-xs, 1/2 width)" },
