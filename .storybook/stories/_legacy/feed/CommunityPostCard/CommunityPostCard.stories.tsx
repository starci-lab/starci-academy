...
} from "@sb-components/_legacy/designs/feed/CommunityPostCard/CommunityPostCard"
...
const meta: Meta<typeof CommunityPostCard> = {
    title: "Legacy/Design/Feed/CommunityPostCard",
...
const FOOTER_REACTIONS: AnatomyNode = { name: "ReactionBar", tier: "block", role: "thả cảm xúc trong footer" }
...
const READONLY_PARTS: Array<AnatomyNode> = framed([
    ...
    ...HEADER_TEXT,
    BODY_MARKDOWN,
    { name: "ReactionBar", tier: "block", role: "hiển thị cảm xúc (chỉ đọc)", state: "read-only" },
