...
import { ModelByline, VerdictIcon } from "@sb-components/_legacy/designs/grading/GradingByline/GradingByline"
import { AiModelCategory } from "@sb-components/_legacy/designs/chips/AiCategoryChip/AiCategoryChip"
...
const meta: Meta<typeof ModelByline> = {
    title: "Legacy/Design/Grading/GradingByline",
...
export const BylineWithLabel: Story = {
    render: () =>
        shell(
            ...
            >
                <div className="flex flex-wrap items-center gap-2" data-anat-part="ModelByline">
