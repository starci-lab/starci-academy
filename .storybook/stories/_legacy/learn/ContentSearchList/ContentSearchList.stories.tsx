...
const meta: Meta<typeof ContentSearchList> = {
    title: "Legacy/Block/Learn/ContentSearchList",
...
// EMPTY leaf — query không rỗng nhưng isEmpty=true: AsyncContent nhánh empty → AsyncContentEmpty (qua FeedbackEmpty).
        ...
        children: [
            {
                ...
                state: "empty",
                children: [
                    { name: "AsyncContentEmpty", tier: "composite", role: "dòng 'không tìm thấy' — CÙNG câu với leaf lỗi" },
                ],
            },
        ],
    },
...
// ERROR leaf — hasError=true: AsyncContent nhánh error (ưu tiên cao nhất) → AsyncContentError, CÙNG câu với empty.
        ...
        children: [
            {
                ...
                state: "error",
                children: [
                    { name: "AsyncContentError", tier: "composite", role: "dòng 'không tìm thấy' — nguồn dùng CHUNG một câu cho empty và error" },
                ],
            },
        ],
    },
