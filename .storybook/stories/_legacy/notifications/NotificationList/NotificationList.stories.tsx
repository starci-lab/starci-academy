...
const meta: Meta<typeof NotificationList> = {
    title: "Legacy/Block/Notifications/NotificationList",
...
const SkeletonNotificationRow = () => (
    ...
    >
        <HeroSkeleton className="size-10 shrink-0 rounded-2xl" data-anat-part="Skeleton.Tile" />
        <div className="flex min-w-0 flex-1 flex-col gap-1">
            <Typography size="sm" isSkeleton className="w-3/4" anatPart="Skeleton.Title" />
            <Typography size="xs" isSkeleton className="w-full" anatPart="Skeleton.Body" />
            <Typography size="xs" isSkeleton className="w-1/3" anatPart="Skeleton.Time" />
        </div>
    </div>
)
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex max-h-[420px] flex-col gap-3 p-1">
                            <div className="flex flex-col gap-1">
                                <HeroSkeleton className="mx-3 mt-1 h-3 w-16 rounded" data-anat-part="Skeleton.GroupLabel" />
