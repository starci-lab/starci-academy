...
const meta: Meta<typeof IconTile> = {
    title: "Atoms/Display/IconTile/IconTile",
    component: IconTile,
    tags: ["autodocs"],
    parameters: {
        layout: "fullscreen",
            ...
            <BlockAnatomy
                ...
                states={[
                    ...
                    },
                    {
                        ...
                        code: "<IconTile tone=\"success\" icon={FolderIcon} />",
                        render: <IconTile tone="success" icon={FolderIcon} />,
                    },
                    {
                        name: "tone = \"warning\"",
                        ...
                        code: "<IconTile tone=\"warning\" icon={FolderIcon} />",
                        render: <IconTile tone="warning" icon={FolderIcon} />,
                    },
                    {
                        name: "tone = \"danger\"",
                        ...
                        code: "<IconTile tone=\"danger\" icon={FolderIcon} />",
            ...
            <BlockAnatomy
                ...
                states={[
                    ...
                    },
                    {
                        ...
                        code: "<IconTile size=\"md\" icon={RocketLaunchIcon} />",
                        render: <IconTile size="md" icon={RocketLaunchIcon} />,
                    },
                    {
                        name: "size = \"lg\"",
                        ...
                        code: "<IconTile size=\"lg\" icon={RocketLaunchIcon} />",
                        render: <IconTile size="lg" icon={RocketLaunchIcon} />,
                    },
                ]}
            />
        </div>
            ...
            <BlockAnatomy
                ...
                states={[
                    ...
                    },
                    {
                        ...
                        code: `<IconTile icon={BookOpenIcon} src="${COURSE_COVER}" alt="React Patterns course cover" />`,
                        render: (
                            <IconTile
                                icon={BookOpenIcon}
                                size="lg"
                    ...
                    },
                    {
                        ...
                        code: `<IconTile icon={BookOpenIcon} src="${BROKEN_COVER}" alt="Broken cover" />`,
                        render: <IconTile icon={BookOpenIcon} size="lg" src={BROKEN_COVER} alt="Broken cover" />,
                    },
                ]}
            />
        </div>
            ...
            <BlockAnatomy
                ...
                states={[
                    ...
                    },
                    {
                        ...
                        code: "<IconTile isSkeleton size=\"md\" />",
                        render: <IconTile isSkeleton size="md" />,
                    },
                    {
                        ...
                        code: "<IconTile isSkeleton size=\"lg\" />",
                        render: <IconTile isSkeleton size="lg" />,
                    },
                ]}
            />
        </div>
