...
/**
 * ATOM — `PricePoint`: tier/subscription price as ONE baseline-aligned unit
 ...
 * `Chip`/`Typography`): `{isSkeleton:true; amount?}` vs
 * `{isSkeleton?:false; amount:required}`. The `Skeleton` leaf below passes no `amount`
 * on purpose — the shimmer never reads it.
 *
 * This atom composes `Typography` for ALL three parts now, amount included
 * (previously raw HeroUI `Typography`, kept only because `Typography` did not
 * cover heading sizes yet). `showAnatomy`/`anatPart` forward down into those calls,
 * and the atom tags all three with the SAME `anatPart="Typography"` — the REAL
 ...
 * not by name, so three same-named `Typography` nodes still show up as three
...
const meta: Meta<typeof PricePoint> = {
    title: "Atoms/Display/PricePoint/PricePoint",
...
/** Story đích của cả ba part — chúng đều là `Typography`, khác nhau ở cỡ/tone. */
 ...
 * MỘT real component, `Typography`, nên chia sẻ một entry theo tên thật thay
...
const ANNOTATE_TYPOGRAPHY: Record<string, AnatomyAnnotation> = {
    "Typography": {
        role: "One of the three price parts (the prominent amount, the struck original, or the billing period) — each a Typography instance riding this atom's own per-size type scale.",
        tier: "atom",
                ...
                states={[
                    {
                        ...
                        code: "<PricePoint amount=\"$19\" />",
                        render: <PricePoint amount="$19" showAnatomy />,
                    },
                ]}
            />
        </div>
            ...
            <BlockAnatomy
                ...
                states={[
                    ...
                    },
                    {
                        ...
                        code: "<PricePoint amount=\"$19\" original=\"$29\" />",
                        render: <PricePoint amount="$19" original="$29" showAnatomy />,
                    },
                ]}
            />
        </div>
            ...
            <BlockAnatomy
                ...
                states={[
                    ...
                    },
                    {
                        ...
                        code: "<PricePoint amount=\"$19\" period=\"/month\" />",
                        render: <PricePoint amount="$19" period="/month" showAnatomy />,
                    },
                ]}
            />
        </div>
                ...
                states={[
                    {
                        ...
                        code: "<PricePoint size=\"sm\" amount=\"$9\" original=\"$14\" period=\"/month\" />",
                        render: <PricePoint size="sm" amount="$9" original="$14" period="/month" showAnatomy />,
                    },
                    {
                        ...
                        code: "<PricePoint size=\"md\" amount=\"$19\" original=\"$29\" period=\"/month\" />",
                        render: <PricePoint size="md" amount="$19" original="$29" period="/month" showAnatomy />,
                    },
                    {
                        name: "size = \"lg\"",
                        ...
                        code: "<PricePoint size=\"lg\" amount=\"$49\" original=\"$69\" period=\"/month\" />",
                        render: <PricePoint size="lg" amount="$49" original="$69" period="/month" showAnatomy />,
                    },
                ]}
            />
        </div>
                ...
                states={[
                    {
                        ...
                        code: "<PricePoint isSkeleton size=\"sm\" />",
                        render: <PricePoint isSkeleton size="sm" showAnatomy />,
                    },
                    {
                        ...
                        code: "<PricePoint isSkeleton size=\"md\" />",
                        render: <PricePoint isSkeleton size="md" showAnatomy />,
                    },
                    {
                        ...
                        code: "<PricePoint isSkeleton size=\"lg\" />",
                        render: <PricePoint isSkeleton size="lg" showAnatomy />,
                    },
                    {
                        ...
                        code: "<PricePoint isSkeleton size=\"md\" period=\"/month\" />",
                        render: <PricePoint isSkeleton size="md" period="/month" showAnatomy />,
                    },
                ]}
            />
        </div>
