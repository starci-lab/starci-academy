...
import { InputTime } from "@sb-components/atoms/forms/Input/Input"
import { BlockAnatomy, type AnatomyAnnotation } from "@sb-utils/BlockAnatomy/BlockAnatomy"

const meta: Meta = { title: "Atoms/Forms/Input/InputTime", tags: ["autodocs"], parameters: { layout: "fullscreen" } }
export default meta
type Story = StoryObj
                    ...
                    states={[
                        {
                            ...
                            render: <InputTime value={value} onValueChange={setValue} ariaLabel="Start time" showAnatomy />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            render: <InputTime label="Start time" hint="Vietnam time (GMT+7)" value={value} onValueChange={setValue} showAnatomy />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            render: <InputTime label="Start time" isRequired value={value} onValueChange={setValue} showAnatomy />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            render: <InputTime label="Start time" value={value} onValueChange={setValue} showAnatomy />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            render: <InputTime label="Start time" value={value} onValueChange={setValue} isDisabled showAnatomy />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            render: <InputTime label="Start time" errorMessage="Please choose a time" value={value} onValueChange={setValue} showAnatomy />,
                        },
                    ]}
                />
            )
                ...
                states={[
                    {
                        ...
                        render: <InputTime label="Start time" value={null} onValueChange={() => {}} isSkeleton showAnatomy />,
                    },
                ]}
            />
        </div>
