...
import { InputDate } from "@sb-components/atoms/forms"
import { BlockAnatomy, type AnatomyAnnotation } from "@sb-utils/BlockAnatomy/BlockAnatomy"

const meta: Meta = { title: "Atoms/Forms/InputDate", tags: ["autodocs"], parameters: { layout: "fullscreen" } }
export default meta
type Story = StoryObj
                    ...
                    states={[
                        {
                            ...
                            code: "<InputDate ariaLabel=\"Start date\" value={value} onValueChange={setValue} />",
                    ...
                    states={[
                        {
                            ...
                            code: "<InputDate ariaLabel=\"Start date\" label=\"Start date\" hint=\"Format: dd/mm/yyyy\" value={value} onValueChange={setValue} />",
                            render: <InputDate ariaLabel="Start date" label="Start date" hint="Format: dd/mm/yyyy" value={value} onValueChange={setValue} />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputDate ariaLabel=\"Start date\" label=\"Start date\" isRequired value={value} onValueChange={setValue} />",
                            render: <InputDate ariaLabel="Start date" label="Start date" isRequired value={value} onValueChange={setValue} />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputDate ariaLabel=\"Start date\" label=\"Start date\" value={parseDate(\"2026-07-25\")} onValueChange={setValue} />",
                            render: <InputDate ariaLabel="Start date" label="Start date" value={value} onValueChange={setValue} />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputDate ariaLabel=\"Start date\" label=\"Start date\" value={parseDate(\"2026-07-25\")} onValueChange={setValue} isDisabled />",
                            render: <InputDate ariaLabel="Start date" label="Start date" value={value} onValueChange={setValue} isDisabled />,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputDate ariaLabel=\"Start date\" label=\"Start date\" errorMessage=\"Please choose a date\" value={value} onValueChange={setValue} />",
                            render: <InputDate ariaLabel="Start date" label="Start date" errorMessage="Please choose a date" value={value} onValueChange={setValue} />,
                        },
                    ]}
                />
            )
                ...
                states={[
                    {
                        ...
                        code: "<InputDate ariaLabel=\"Start date\" label=\"Start date\" isSkeleton />",
                        render: <InputDate ariaLabel="Start date" label="Start date" value={null} onValueChange={() => {}} isSkeleton />,
                    },
                ]}
            />
        </div>
