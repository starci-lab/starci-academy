...
import { InputPassword } from "@sb-components/atoms/forms"
import { BlockAnatomy, type AnatomyAnnotation } from "@sb-utils/BlockAnatomy/BlockAnatomy"

const meta: Meta = { title: "Atoms/Forms/InputPassword", tags: ["autodocs"], parameters: { layout: "fullscreen" } }
export default meta
type Story = StoryObj
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" value={v} onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" value={value} onValueChange={setValue} ariaLabel="Password" /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" placeholder=\"Password\" value={v} onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" placeholder="Password" value={value} onValueChange={setValue} ariaLabel="Password" /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" hint=\"At least 8 characters\" value={v} onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" hint="At least 8 characters" value={value} onValueChange={setValue} placeholder="Password" /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" isRequired value={v} onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" isRequired value={value} onValueChange={setValue} placeholder="Password" /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" value=\"SuperSecure!2026\" onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" value={value} onValueChange={setValue} /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" value=\"SuperSecure!2026\" isDisabled onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" value={value} onValueChange={setValue} isDisabled /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" isInvalid value={v} onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" isInvalid value={value} onValueChange={setValue} placeholder="Password" /></div>,
                        },
                    ]}
                />
            )
                    ...
                    states={[
                        {
                            ...
                            code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" errorMessage=\"Password is too short\" value={v} onValueChange={setV} />",
                            render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" errorMessage="Password is too short" value={value} onValueChange={setValue} placeholder="Password" /></div>,
                        },
                    ]}
                />
            )
                ...
                states={[
                    {
                        ...
                        code: "<InputPassword hideLabel=\"Hide password\" revealLabel=\"Show password\" label=\"Password\" isSkeleton />",
                        render: <div data-tier="fixture" className="w-72"><InputPassword hideLabel="Hide password" revealLabel="Show password" label="Password" value="" onValueChange={() => {}} isSkeleton /></div>,
                    },
                ]}
            />
        </div>
