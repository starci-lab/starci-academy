...
const meta: Meta<typeof Typography.Lg> = {
    title: "Atoms/Text/Typography/Typography.Lg",
    component: Typography.Lg,
    tags: ["autodocs"],
    parameters: {
        layout: "fullscreen",
...
const L = makeTypographyLeaves(Typography.Lg, "Typography.Lg")
