...
const meta: Meta<typeof Typography.Sm> = {
    title: "Atoms/Text/Typography/Typography.Sm",
    component: Typography.Sm,
    tags: ["autodocs"],
    parameters: {
        layout: "fullscreen",
...
const L = makeTypographyLeaves(Typography.Sm, "Typography.Sm")
