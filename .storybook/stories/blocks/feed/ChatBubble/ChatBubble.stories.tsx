...
// Every leaf shares this composition — a row that aligns by role, wrapping the tinted bubble.
const CHAT_BUBBLE_PARTS: Array<AnatomyNode> = [
    {
        name: "div · row",
        tier: "primitive",
        role: "căn lề theo role (user phải · assistant trái)",
        children: [
            { name: "div · bubble", tier: "primitive", role: "khung bong bóng tint + bo góc + đệm" },
        ],
    },
]
...
export const Default: Story = {
    render: () =>
        frame(
            ...
            >
                <div className="w-96">
                    <ChatBubble role="assistant" showAnatomy>Chào bạn, mình có thể giúp gì hôm nay?</ChatBubble>
                </div>
            </BlockAnatomy>,
        ),
}
...
export const RoleUser: Story = {
    render: () =>
        frame(
            ...
            >
                <div className="w-96">
                    <ChatBubble role="user" showAnatomy>Làm sao để debug memory leak trong Node.js?</ChatBubble>
                </div>
            </BlockAnatomy>,
        ),
}
...
export const RoleAssistant: Story = {
    render: () =>
        frame(
            ...
            >
                <div className="w-96">
                    <ChatBubble role="assistant" showAnatomy>
