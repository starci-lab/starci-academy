...
/**
 * ─────────────────────────────────────────────────────────────────────────────
 * STORYBOOK-LOCAL DESIGN SPEC — full port of `@/components/blocks/form/SearchInput`.
 * Authored in Storybook (not `src`); synced to `src` later. Faithful port of the
 * whole prop API + typeahead behaviour + class names; no `@/components` import.
 * The src falls the placeholder back to next-intl `search.placeholder` — here
 * that fallback is inlined literally so the block renders without a provider.
 * ─────────────────────────────────────────────────────────────────────────────
 */

/** Fallback placeholder (inlined from the `search.placeholder` i18n key). */
const DEFAULT_PLACEHOLDER = "Tìm khoá học, học phần, video..."
