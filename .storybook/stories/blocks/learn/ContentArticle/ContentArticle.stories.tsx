...
import { ContentArticle } from "@sb-components/blocks/learn/ContentArticle/ContentArticle"
...
const meta: Meta<typeof ContentArticle> = {
    title: "Blocks/Learn/ContentArticle/ContentArticle",
...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "ContentPaywall": { tier: "block", role: "the offer under the faded tail, reused unchanged so pricing reads the same here as on the course page", storyId: "blocks-learn-contentpaywall-contentpaywall--full" },
}
