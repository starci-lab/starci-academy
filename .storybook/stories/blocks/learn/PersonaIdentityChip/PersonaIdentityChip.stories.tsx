...
const SKELETON_PARTS: Array<AnatomyNode> = [
    { name: "Skeleton.Avatar", tier: "primitive", role: "avatar dot placeholder" },
    { name: "Skeleton.Typography", tier: "primitive", role: "dòng tên (width 1/2)" },
    { name: "Skeleton.Typography", tier: "primitive", role: "dòng vai trò (width 1/3)" },
]
