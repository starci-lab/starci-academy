...
const meta: Meta<typeof VariantChipDifficulty> = {
    title: "Blocks/Learn/VariantChip/VariantChipDifficulty",
...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    // `"blocks-learn-variantchip-variantchipdifficulty--levels"`).
    "VariantChipDifficulty": {
        storyId: "blocks-learn-variantchip-variantchipdifficulty--levels",
        tier: "block",
