...
/**
 * ─────────────────────────────────────────────────────────────────────────────
 * STORYBOOK-LOCAL DESIGN SPEC — full port of `@/components/blocks/lists/ListRow`.
 * Authored in Storybook (not `src`); synced to `src` later.
 *
 * A heavily-reused, purely-presentational GitHub-style list row: optional leading
 * icon/avatar · title (+ optional subtitle) text column · right-aligned meta +
 * trailing cluster. Text and handlers arrive via props so the row stays store-free.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
/**
 * Generic GitHub-style list row designed to live inside a SectionCard or any
