 ...
 * `@/components/blocks/marketing/ArchitectureScene`. Authored in Storybook (not
 * `src`); synced to `src` later. Mini 3D architecture scene (real WebGL via
 * react-three-fiber) for the landing hero, in a flat isometric "tiles on a grid"
 * style: a square iso floor board where every node is a flat-shaded slab centred
 * on its own cell, wired into a small DAG.
 *
