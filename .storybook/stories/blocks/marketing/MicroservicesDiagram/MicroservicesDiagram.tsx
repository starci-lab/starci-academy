 ...
 * `@/components/blocks/marketing/MicroservicesDiagram`. Authored in Storybook
 * (not `src`); synced to `src` later. A coded hero illustration: a curated
 * microservices topology framed over a blueprint dot-grid with the failure
 * points floated beside the area they threaten (Framer Motion animation).
 */
