 ...
 * `@/components/blocks/marketing/ShowcaseMockup`. Authored in Storybook (not
 * `src`); synced to `src` later. A reusable "browser window" showcase frame:
 * chrome (3 dots + address bar) + tilt + coloured glow, holding any content.
 */
