 ...
 * `@/components/blocks/marketing/TrackCard`. Authored in Storybook (not `src`);
 * synced to `src` later. A learning-track card: identity header over a vertical
 * 4-tier path with a "Vào khóa" CTA.
 */
