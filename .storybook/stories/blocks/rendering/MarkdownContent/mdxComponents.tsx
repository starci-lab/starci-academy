...
/**
 * STORYBOOK-LOCAL DESIGN SPEC — faithful port of the src `mdxComponents`. Synced
 * to `src` later.
 *
 ...
 * REAL, interactive component with HeroUI's DEFAULT styling (no extra CSS).
 *
 * Non-renderables are filtered out: ALL-CAPS constants (`DEFAULT_*`, `REGEXP_*`),
 * React contexts (`*Context`) and providers (`*Provider`).
 */
