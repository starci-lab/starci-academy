...
import { SurfaceCard, type SurfaceCardSelectableGroupItem } from "@sb-components/composites/cards/SurfaceCard/SurfaceCard"
...
const meta: Meta<typeof SurfaceCard.SelectableGroup> = {
    title: "Composites/Cards/SurfaceCard/SurfaceCard.SelectableGroup",
