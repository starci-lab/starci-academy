...
const ROW_PARTS: Array<AnatomyNode> = [
    { name: "Typography.Base", tier: "atom", role: "label (Sm muted, §9a SECONDARY text) and value (Sm medium + tabular-nums, an ALREADY-formatted node)", storyId: "atoms-text-typography-typography-base--colors" },
]
const HINT_PARTS: Array<AnatomyNode> = [
    { name: "Typography.Base", tier: "atom", role: "label (Sm muted) · hint (Xs muted, a secondary line under the label, gap-1 §10 tight) · value (Sm medium + tabular-nums)", storyId: "atoms-text-typography-typography-base--colors" },
]
const EMPHASIS_PARTS: Array<AnatomyNode> = [
    { name: "Typography.Base", tier: "atom", role: "label (Sm foreground + medium, total row's label) and value (Base BOLD + tabular-nums, a large number, §9b)", storyId: "atoms-text-typography-typography-base--bold" },
]
