...
import { FeedbackConfirm } from "@sb-components/composites/feedback/Feedback/Feedback"
import { BlockAnatomy, type AnatomyAnnotation } from "@sb-utils/BlockAnatomy/BlockAnatomy"

/**
 * COMPOSITE (composite tier) — `FeedbackConfirm`: vỏ dialog CHẶN ĐƯỜNG cho hành động
 ...
 * Header[→Heading] · Body[→Typography] · Footer[→Button × 2]`) — tier
 * `heroui` cho mọi node của thư viện (2026-07-28, LUẬT node = tên component thật).
 * `Footer` forward `showAnatomy` xuống `ButtonGroup` nên hai nút THẬT
 * (`Button`) hiện ra, thay vì dán nhãn "Footer" giả làm chính `ButtonGroup`.
 *
 * 2026-07-27: di trú toàn bộ leaf sang API `states[]` (§8/§4a).
 */
const meta: Meta<typeof FeedbackConfirm> = {
    title: "Composites/Feedback/Feedback/FeedbackConfirm",
...
type Story = StoryObj<typeof FeedbackConfirm>
 ...
 * nhảy là `Typography` (mô tả) và `Button` (hai nút, do `ButtonGroup` dựng).
 */
