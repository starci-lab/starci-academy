...
/**
 * `Disclosure` is the generic collapsible khung: a trigger row (leading
                ...
                states={[
                    {
                        ...
                        code: "<Disclosure title=\"Customize session\"><SampleContent /></Disclosure>",
                        render: (
                            <Disclosure title="Tùy chỉnh phiên" showAnatomy>
                                <SampleContent />
                            </Disclosure>
                        ),
                    },
...
const ControlledExample = () => {
    ...
    return (
        <Disclosure title="Tùy chỉnh phiên" isOpen={open} onOpenChange={setOpen} showAnatomy>
            <SampleContent />
        </Disclosure>
    )
}
                ...
                states={[
                    {
                        ...
                        code: "<Disclosure title=\"Customize session\" isOpen={open} onOpenChange={setOpen}><SampleContent /></Disclosure>",
                ...
                states={[
                    {
                        ...
                        code: "<Disclosure title=\"Customize session\" isDisabled><SampleContent /></Disclosure>",
                        render: (
                            <Disclosure title="Tùy chỉnh phiên" isDisabled showAnatomy>
                                <SampleContent />
                            </Disclosure>
                        ),
                    },
                ...
                states={[
                    {
                        ...
                        render: (
                            <Disclosure title="Tùy chỉnh phiên" isSkeleton showAnatomy>
                                <SampleContent />
                            </Disclosure>
                        ),
                    },
