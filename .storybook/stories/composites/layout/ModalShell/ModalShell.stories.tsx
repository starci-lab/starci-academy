...
const meta: Meta<typeof ModalShell> = {
    title: "Composites/Layout/ModalShell/ModalShell",
                ...
                states={[
                    {
                        ...
                        code,
                        render: (
                            <ModalShell isOpen={isOpen} onOpenChange={setIsOpen} showAnatomy {...rest}>
                                {children}
                            </ModalShell>
                        ),
                    },
    ...
    render: () => (
        <div className="p-8">
            <ControlledModal
                ...
                code={`<ModalShell header={<InviteHeader />}>
    ...
    render: () => (
        <div className="p-8">
            <ControlledModal
                ...
                code={`<ModalShell title="Transaction history" size="lg" scroll="inside">
