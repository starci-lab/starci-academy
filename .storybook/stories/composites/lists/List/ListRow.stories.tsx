...
/>`,
                        render: (
                            <div className="w-full max-w-md rounded-2xl border border-default px-3">
                                <ListRow title="Bài tập buổi 1: Vòng lặp và điều kiện" showAnatomy />
                            </div>
                        ),
                    },
                ]}
                ...
                states={[
                    {
                        ...
                        code: `<ListRow title="Buổi 1…" subtitle="Hoàn thành" divider />
<ListRow title="Buổi 2…" subtitle="Hoàn thành" divider />
<ListRow title="Buổi 3…" subtitle="Đang học" />`,
                        render: (
                            <div className="w-full max-w-md rounded-2xl border border-default px-3">
                                <ListRow title="Buổi 1: Vòng lặp và điều kiện" subtitle="Hoàn thành" divider showAnatomy />
