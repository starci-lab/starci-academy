...
const statCell = (icon: React.ReactNode, label: string, current: number, target: number) => (
    <>
        <div data-tier="fixture" className="flex items-center justify-between gap-2">
        ...
        <div data-tier="fixture" className="h-1.5 w-full overflow-hidden rounded-full bg-default">
            <div
...
const icon = (Component: typeof BookOpenIcon) => (
    <Component data-tier="fixture" aria-hidden focusable="false" className="size-5 shrink-0" />
)
