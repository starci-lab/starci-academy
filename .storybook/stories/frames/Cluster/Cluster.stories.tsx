...
/>`,
                        render: surface(<Cluster showAnatomy gap="related" items={tagItems(TAGS)} />),
                    },
                ]}
            />
        </div>
                ...
                states={[
                    {
                        ...
                        code: "<Cluster gap=\"flush\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="flush" items={tagItems(TAGS.slice(0, 4))} />),
                    },
                    {
                        ...
                        code: "<Cluster gap=\"tight\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="tight" items={tagItems(TAGS.slice(0, 4))} />),
                    },
                    {
                        ...
                        code: "<Cluster gap=\"related\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="related" items={tagItems(TAGS.slice(0, 4))} />),
                    },
                    {
                        ...
                        code: "<Cluster gap=\"grouped\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="grouped" items={tagItems(TAGS.slice(0, 4))} />),
                    },
                    {
                        ...
                        code: "<Cluster gap=\"section\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="section" items={tagItems(TAGS.slice(0, 4))} />),
                    },
                    {
                        ...
                        code: "<Cluster gap=\"page\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="page" items={tagItems(TAGS.slice(0, 4))} />),
                    },
                ]}
            />
        </div>
                ...
                states={[
                    {
                        ...
                        code: "<Cluster gap=\"related\" justify=\"start\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="related" justify="start" items={tagItems(TAGS.slice(0, 3))} />),
                    },
                    {
                        name: "justify = \"center\"",
                        ...
                        code: "<Cluster gap=\"related\" justify=\"center\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="related" justify="center" items={tagItems(TAGS.slice(0, 3))} />),
                    },
                    {
                        name: "justify = \"end\"",
                        ...
                        code: "<Cluster gap=\"related\" justify=\"end\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="related" justify="end" items={tagItems(TAGS.slice(0, 3))} />),
                    },
                    {
                        ...
                        code: "<Cluster gap=\"related\" justify=\"between\" items={…} />",
                        render: surface(<Cluster showAnatomy gap="related" justify="between" items={tagItems(TAGS.slice(0, 3))} />),
                    },
                ]}
            />
        </div>
