 ...
 * này, không phải tuỳ chọn; hàng nhiều-phần-tử thì dùng `StackH`/`Cluster`.
 */
                        ...
                        render: (
                            <Frame width="24rem" label="container 384px, below @app-sm, stacks into a column">
                                <Split
                                    ...
                                    stackOnMobile
                                    gap="grouped"
                                    start={<Typography size="sm" text="Gói Pro — thanh toán theo năm" weight="medium" />}
                                    end={<Button label="Nâng cấp" size="sm" />}
                                />
                            </Frame>
                        ),
                    },
