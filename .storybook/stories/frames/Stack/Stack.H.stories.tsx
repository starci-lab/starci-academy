...
const TRACK_PARTS: Array<AnatomyNode> = [
    { name: "Track", tier: "composite", role: "the horizontal flex axis — owns gap (§10), align, justify, wrap" },
]
const DIVIDER_PARTS: Array<AnatomyNode> = [
    { name: "Track", tier: "composite", role: "the horizontal flex axis — owns gap (§10)" },
