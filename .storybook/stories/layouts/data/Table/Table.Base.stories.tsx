...
const meta: Meta<typeof Table.Base> = {
    title: "Layouts/Data/Table/Table.Base",
...
const TABLE_PARTS: Array<AnatomyNode> = [
    {
        ...
        children: [
            { name: "Column", tier: "primitive", role: "một cột: `header` + canh lề + bề rộng" },
        ],
    },
    {
        name: "Body",
        ...
        children: [
            { name: "Row", tier: "primitive", role: "một hàng; mỗi ô đọc `item[column.key]`" },
        ],
    },
]
...
const EMPTY_PARTS: Array<AnatomyNode> = [
    {
        ...
        children: [{ name: "Column", tier: "primitive", role: "một cột" }],
    },
    {
        name: "Body",
        tier: "primitive",
        role: "thân bảng rỗng",
        children: [{ name: "Empty", tier: "primitive", role: "`emptyContent` trải hết bề ngang thân bảng" }],
    },
]
...
const SKELETON_PARTS: Array<AnatomyNode> = [
    ...
    },
    {
        ...
        children: [{ name: "Row", tier: "primitive", role: "hàng mirror — mỗi ô là một thanh `Skeleton.Typography`" }],
    },
]
