...
import { ContentScreen } from "@sb-components/screens/ContentScreen/ContentScreen"
...
const meta: Meta<typeof ContentScreen> = {
    title: "Screens/ContentScreen/ContentScreen",
...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "ContentHeader": { tier: "block", role: "what this lesson is: trail, title, description, read state and reading time, and what the reader will learn", storyId: "blocks-learn-contentheader-contentheader--full" },
    "ContentTabBar": { tier: "block", role: "how to look at the lesson — reading, sandbox, challenges or AI lab; static chrome that never waits for data", storyId: "blocks-learn-contenttabbar-contenttabbar--full" },
    "ContentArticle": { tier: "block", role: "the lesson itself, and when it is locked the faded tail with the offer under it inside the same card", storyId: "blocks-learn-contentarticle-contentarticle--open" },
    "ContentReaction": { tier: "block", role: "say how the lesson landed, beside the quiet view count", storyId: "blocks-learn-contentreaction-contentreaction--full" },
    "ContentRelatedList": { tier: "block", role: "what else in the course is worth reading; draws nothing at all when there is nothing related", storyId: "blocks-learn-contentrelatedlist-contentrelatedlist--full" },
    "ContentDiscussion": { tier: "block", role: "talk about the lesson: a composer that never hides, and the thread under it", storyId: "blocks-learn-contentdiscussion-contentdiscussion--full" },
    "ContentPager": { tier: "block", role: "step to the neighbouring lesson; renders nothing on the first and last lesson of a module", storyId: "blocks-learn-contentpager-contentpager--full" },
}
