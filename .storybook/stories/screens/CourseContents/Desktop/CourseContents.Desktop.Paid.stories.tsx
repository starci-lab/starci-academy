...
export const Default: Story = {
    render: () => deviceLeaf({ state: "content", viewer: "paid", leaf: "Default", reason: "Đã mua — cây rụng Callout + TrialConversionStrip, còn 4 block: Header · ContinueCard · LearnNudges · KeepGoingPath." }),
}
