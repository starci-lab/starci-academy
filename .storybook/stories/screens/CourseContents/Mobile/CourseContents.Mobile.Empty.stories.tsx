...
/**
 * SCREEN `/learn/content` at MOBILE (375px, below `@app-sm`) — EMPTY:
...
export const Default: Story = {
    render: () => deviceLeaf({ width: W, isEmpty: true, leaf: "Default", reason: "Mobile 375px · no lessons yet — AsyncContent.Empty replaces the whole spine." }),
}
