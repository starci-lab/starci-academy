...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "EnumChip": { tier: "composite", role: "the readiness band, mapped from the closed needsWork/building/jobReady set to a soft chip tone", storyId: "composites-chips-enumchip--overview" },
    "Typography": { tier: "atom", role: "the foundation-percentile line, or a pillar's skeleton label", storyId: "atoms-text-typography-typography--overview" },
