...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Typography": { tier: "atom", role: "a prerequisite/output row — plain text, no markdown; the backend content schema names this field \"text\", not \"body\", a different tier from requirements/steps", storyId: "atoms-text-typography-typography--overview" },
