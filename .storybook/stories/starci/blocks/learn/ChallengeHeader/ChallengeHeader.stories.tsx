...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Typography": { tier: "atom", role: "one of the block's own text lines — the title, or the quiet score fact — real or its skeleton mirror", storyId: "atoms-text-typography-typography--overview" },
