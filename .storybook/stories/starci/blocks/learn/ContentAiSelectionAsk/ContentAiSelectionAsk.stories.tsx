...
/**
 * BLOCK — `ContentAiSelectionAsk`: the "Hỏi AI" pill that pops up next to a
 ...
 *
 * 📐 LEAF by STRUCTURE (§14d.2): `isNew` is DATA (whether the "Mới" chip shows
...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Chip": { tier: "atom", role: "the small 'Mới' badge riding next to the pill while the feature is new; the block only decides whether it shows", storyId: "atoms-chips-chip-chip--default" },
}
...
/>`,
                    ...
                    {
                        name: "isNew = true",
                        why: "Early releases carry a 'Mới' chip so a reader who has never used the feature notices it is there before they even select text a second time.",
                        code: `<ContentAiSelectionAsk
    anchor={{ x: 220, y: 160 }}
    isNew
    onOpen={openSideThread}
