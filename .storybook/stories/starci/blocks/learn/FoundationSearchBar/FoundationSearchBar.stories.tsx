...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Typography": { tier: "atom", role: "the match-count text, or its skeleton mirror while `isSkeleton`/`isCountLoading` — content and wording owned entirely by this block", storyId: "atoms-text-typography-typography--overview" },
}
