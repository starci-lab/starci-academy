...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Callout": { tier: "composite", role: "the resume banner when a run was left unfinished, or the failed-draw notice beside the start row", storyId: "composites-feedback-callout--default" },
    ...
    "Typography": { tier: "atom", role: "one of the block's own text lines — interviewer name, role, a field label, or their skeleton mirror", storyId: "atoms-text-typography-typography--overview" },
