...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Typography": { tier: "atom", role: "the tab's label text, and — on a section the owner hid — the muted \"· hidden\" marker riding beside it", storyId: "atoms-text-typography-typography--overview" },
...
/>`,
                    ...
                    },
                    {
                        ...
                        why: "The owner switched \"Skills\" and \"Activity\" off for visitors. They still see both tabs — visitors are simply never handed those keys at all — but each carries a muted \"· hidden\" marker beside its label so the owner can tell which sections are currently private without opening settings.",
                        code: `<ProfileTabsBar
    ariaLabel="Profile"
    activeTab="overview"
    visibleTabs={allTabs}
