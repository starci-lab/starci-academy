...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "InlineIconLabel": { tier: "composite", role: "\"Graded by <model>\", same recipe `SubmissionScoreCard` uses for its own byline", storyId: "composites-texts-inlineiconlabel--overview" },
    "EnumChip": { tier: "composite", role: "the model's cost/quality tier — same `MODEL_CATEGORY_MAP` `SubmissionScoreCard` owns, reused not re-declared", storyId: "composites-chips-enumchip--overview" },
