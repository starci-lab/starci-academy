...
const ANNOTATE: Record<string, AnatomyAnnotation> = {
    ...
    "Typography": { tier: "atom", role: "one of the screen's own text lines — the task title/description, a skeleton mirror, or an owned label like a hint heading", storyId: "atoms-text-typography-typography--overview" },
    "Callout": { tier: "composite", role: "the locked-preview warning banner shown while `isLocked` and the task is not yet unlocked for the learner", storyId: "composites-feedback-callout--default" },
