...
test("content allowlist covers locale dictionaries and fixtures", () => {
  ...
  assert.equal(
    isContentAllowlisted("/repo/.storybook/components/x/PlaygroundSessionProvider/content/guide.ts"),
    true,
  )
  ...
  assert.equal(isContentAllowlisted("/repo/.storybook/utils/BlockAnatomy/BlockAnatomy.tsx"), true)
