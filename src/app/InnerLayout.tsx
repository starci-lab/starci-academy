...
import { CookieConsentBanner } from "@/components/blocks/feedback/CookieConsentBanner"
...
import { DrawerContainer } from "@/components/overlays/drawers/DrawerContainer"
...
import { ModalContainer } from "@/components/overlays/modals/ModalContainer"
import { UseEffects } from "@/hooks/effects/UseEffects"
import { ContentAiChatRail } from "@/components/blocks/learn/ContentAiChat/ContentAiChatRail"
import { ContentAiFab } from "@/components/blocks/learn/ContentAiFab"
...
/** Client app shell: providers, navbar/footer gates, and the content-AI rail. */
export const InnerLayout = ({ children }: PropsWithChildren) => {
    ...
    // Footer renders on LANDING — both the locale root ("/", "/vi", "/en") AND /home ("/home",
    // "/vi/home"): /home is the ungated version of the SAME landing page (signed-in users see it here).
    // Every other page (dashboard / learn / profile / auth / ...) do NOT have a footer — teacher ruling 2026-06-26.
