...
const ProgressBar = ({
    ...
    if (isSkeleton) {
        return <HeroSkeleton className={cn("h-2 w-full rounded-full", className, classNames)} />
    }
    return (
        <HeroProgressBar
...
const ProgressCircle = ({
    ...
    if (isSkeleton) {
        return <HeroSkeleton className={cn("rounded-full", CIRCLE_BOX[size], className, classNames)} />
    }
    return (
        <HeroProgressCircle
            aria-label={ariaLabel}
