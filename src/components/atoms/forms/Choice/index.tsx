 ...
 * `ChoiceRadio` per entry moved to the composite tier (ATOM-8: rendering another
 * house atom once per item is the composite signal, not the atom one).
 */
 ...
 * anymore — it moved to the composite tier (ATOM-8).
 */
