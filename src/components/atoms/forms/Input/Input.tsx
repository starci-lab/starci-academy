...
const FieldSkeleton = ({ heightCls = "h-9", className, classNames }: FieldSkeletonProps) => (
    <HeroSkeleton className={cn("w-full rounded-xl", heightCls, className, classNames)} />
)
...
const InputText = ({ value, onValueChange, placeholder, isDisabled, isInvalid, ariaLabel, isSkeleton, className, classNames, label, hint, errorMessage, isRequired, variant = "primary" }: InputTextProps) => {
    ...
    return (
        <FieldFrame
            ...
            id={controlId}
            skeletonControl={<FieldSkeleton className={className} classNames={classNames} />}
        >
...
const InputTextarea = ({
    ...
    return (
        <FieldFrame
            ...
            isSkeleton={isSkeleton}
            id={controlId}
            skeletonControl={<FieldSkeleton heightCls="h-24" className={className} classNames={classNames} />}
        >
            <HeroTextField variant={variant} aria-label={fieldName(label, ariaLabel)} isInvalid={invalid} isDisabled={isDisabled} className={cn("w-full", className, classNames)}>
                <HeroTextArea
                    id={controlId}
