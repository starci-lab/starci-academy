...
import type { CvBlockTypeMeta } from "@/modules/types/entities/cv"

/**
 * The 7 canonical block types (`CvGalleryPage-BUILDER-BLOCK-EDITOR-BRAINSTORM.md`, "FINAL
 ...
 * the CvGalleryPage's OWN language, independent of the app's UI locale.
 */
