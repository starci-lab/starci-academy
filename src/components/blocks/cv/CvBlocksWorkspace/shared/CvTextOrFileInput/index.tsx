...
/** Max upload size in bytes (10MB — mirrors the legacy CvGalleryPage-upload ceiling). */
 ...
 * text payload into `splitCvFromText` (a CvGalleryPage) or `tailorCvBlocks` (a job
