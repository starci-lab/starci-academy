        ...
        <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
                ...
                <Typography type="body-sm" color="muted">
                    bộ khung ít nhất còn dùng được: tiêu đề và một dòng mô tả. Đủ cho trang quản trị mà người dùng vào thẳng từ menu, không có đường dẫn phân cấp nào để bày.
                </Typography>
            </div>
...
/** Dùng khi trang nằm SÂU trong một phân cấp và người dùng cần biết mình đang ở đâu — lúc đó mới bày đủ các tầng: breadcrumb, tiêu đề, meta. Breadcrumb = `ResponsiveBreadcrumb` (desktop trail ngắn; mobile / trail >=4 → "Trở lại"). */
export const Full: Story = {
    parameters: { usage: "Dùng khi trang nằm SÂU trong một phân cấp và người dùng cần biết mình đang ở đâu — lúc đó mới bày đủ: breadcrumb, tiêu đề, meta. Slot `breadcrumb` dùng `ResponsiveBreadcrumb`: desktop hiện trail ngắn; mobile hoặc trail >=4 rút thành \"Trở lại\". Trang vào thẳng từ menu thì đừng bịa breadcrumb, dùng bộ tối thiểu ở story Default." },
    render: () => (
        <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
                <Label>Đủ tầng sâu</Label>
                <Typography type="body-sm" color="muted">
                    bố cục của trang chi tiết nằm sâu trong phân cấp: khác bộ tối thiểu ở chỗ có ResponsiveBreadcrumb phía trên và một dải meta phía dưới. Chip trạng thái đứng ngoài cùng bên trái; dải meta còn lại là chữ ngăn bằng dấu chấm giữa chứ không phải nhiều chip cạnh nhau. Thu hẹp viewport (hoặc trail từ 4 crumb trở lên) để thấy nút Trở lại.
                </Typography>
            </div>
            <div className="max-w-3xl">
                <PageHeader
