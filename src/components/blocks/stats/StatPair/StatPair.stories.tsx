    ...
    render: (args) => (
        <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
                <Label>Số liệu đơn</Label>
                <Typography type="body-sm" color="muted">
                    Một số liệu đơn lẻ: value lớn trên nhãn mờ, canh trái. Frameless — luôn đặt trong card của parent.
                </Typography>
            </div>
            <StatPair {...args} />
        </div>
...
export const Row: Story = {
    ...
    render: () => (
        <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
                <Label>Dải ngang</Label>
                <Typography type="body-sm" color="muted">
                    Dùng khi bề ngang rộng: 4 StatPair thẳng một hàng, ngăn nhau bằng divider dọc — dải thống kê hero / hồ sơ.
                </Typography>
            </div>
...
export const Grid: Story = {
    ...
    render: () => (
        <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
                <Label>Lưới 2 cột</Label>
                <Typography type="body-sm" color="muted">
                    Dùng khi bề ngang hẹp (sidebar / widget): cùng bộ số nhưng xếp lưới 2 cột vì không đủ chỗ cho một hàng.
                </Typography>
            </div>
