/**
 * BATCH 19 — approved semantic contract resolvers (src twin of SB `_semantic-contracts.mjs`).
 * Keep mappings identical to `.storybook/components/composites/_semantic-contracts.mjs`.
 */
