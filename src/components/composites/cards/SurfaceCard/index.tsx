...
const Base = ({
    ...
    ariaLabel,
    classNames,
    contentClassName}: SurfaceCardBaseProps) => {
...
const Nested = ({
    ...
    variant = "surface",
    isSkeleton = false,
    classNames}: SurfaceCardNestedProps) => {
...
const PressableGroup = ({
    ...
    isSkeleton = false,
    classNames}: SurfaceCardPressableGroupProps) => {
...
const SelectableGroup = <T extends string>({
    ...
    ariaLabel,
    columns = 2,
    classNames}: SurfaceCardSelectableGroupProps<T>) => (
        <RadioGroup
            aria-label={ariaLabel}
            value={value}
...
const List = ({
    ...
    seeMoreLabel,
    action,
    subtleLabel = false}: SurfaceCardListProps) => {
...
const AccordionCard = ({
    ...
    description,
    isSkeleton = false,
    classNames}: SurfaceCardAccordionProps) => {
    const bare = label == null && description == null
...
const CrossList = ({
    ...
    isSkeleton = false,
    skeletonRows = 3,
    classNames}: SurfaceCardCrossListProps) => (
    <ul
...
const Placeholder = ({
    ...
    isDisabled = false,
    isSkeleton = false,
    classNames}: SurfaceCardPlaceholderProps) => {
