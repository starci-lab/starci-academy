 ...
 *
 * WARNING `Dot` is NO LONGER here (instructor locked in 2026-07-25): the dot chip moved
 ...
 *
 * WARNING `Status` and `Tags` have been DROPPED from this namespace (2026-07-26) — same
 ...
 *
 * WARNING `HostPlatform` has been DROPPED from this namespace (2026-07-25):
