...
/** All display text, already localized by the connected `JobDetail`; a story passes i18n keys. */
...
/** Props for {@link _JobDetail} — presentational; all data resolved, no fetch/store/i18n. */
...
const buildMetaItems = ({
    ...
    location,
    postedAgoLabel,
}: Pick<JobDetailProps, "isSkeleton" | "workModeLabel" | "employmentTypeLabel" | "location" | "postedAgoLabel">): Array<ComponentTypeWithSkeleton> => {
    if (isSkeleton) {
        return [
...
/**
 * `_JobDetail` — the presentational half of {@link import("./index").JobDetail}: full posting
