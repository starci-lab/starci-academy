...
/** Already-translated copy {@link _CourseDetail} needs — resolved by the connected `CourseDetail`. */
...
/** Props for {@link _CourseDetail} — presentational; all data resolved, no fetch/store/i18n. */
export type CourseDetailProps = WithClassNames<undefined> & {
     ...
     * the connected `CourseDetail` (first-load formula, `loading-and-skeleton.md` §2).
     */
    isSkeleton?: boolean
...
/**
 * Marketing-first course landing (UI 2.0) — the presentational half of {@link CourseDetail}: a
 ...
 *
 * @param props - {@link CourseDetailProps}
 */
const _CourseDetail = ({
    className,
    isSkeleton = false,
    ...
    return (
        <div className={className} data-tier="page" data-component="CourseDetail">
