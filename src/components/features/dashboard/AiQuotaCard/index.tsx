...
export const AiQuotaCard = () => {
    ...
    const windows: Array<AiQuotaCardWindow> = data ? [
        {
            key: "window5h",
            label: t("dashboard.aiQuota.window5h"),
            creditsText: t("dashboard.aiQuota.credits", {
        ...
        {
            key: "windowWeek",
            label: t("dashboard.aiQuota.windowWeek"),
            creditsText: t("dashboard.aiQuota.credits", {
    ...
    return (
        <_AiQuotaCard
            ...
            // copy as the other dashboard right-rail cards, no new i18n key
            ...
            labels={{
                title: t("dashboard.aiQuota.title"),
                poolCaption: t("dashboard.aiQuota.poolCaption"),
                upgrade: t("dashboard.aiQuota.upgrade"),
