...
/**
 * Compact weekly-league card for the dashboard — the CONNECTED half: self-fetches the
...
export const LeagueCard = ({
    ...
    const pointsLabel = useCallback(
        (weekPoints: number) => t("dashboard.league.points", { count: weekPoints }),
        [t],
    )
    ...
    return (
        <_LeagueCard
            ...
            titleHelp={t("dashboard.league.help")}
            onSeeMore={onSeeMore}
            ...
            standing={myEntry && myPercent !== null ? {
                ...
                secondary: `${pointsLabel(myEntry.weekPoints)} · ${t("dashboard.league.resetIn", {
                    days: countdown.days,
