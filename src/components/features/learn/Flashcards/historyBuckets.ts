...
export type TimeBucketKey = "today" | "week" | "month" | "older"
...
const BUCKET_ORDER: ReadonlyArray<TimeBucketKey> = ["today", "week", "month", "older"]

const DAY_MS = 24 * 60 * 60 * 1000

/** Day-relative bucket for one ISO timestamp (`now` passed in so callers stay pure/testable). */
