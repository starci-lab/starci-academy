...
/** Props for {@link ModuleOutlineSkeleton}. */
export interface ModuleOutlineSkeletonProps extends WithClassNames<undefined> {
    /** Number of placeholder module rows to render. */
    count: number
}

/**
 * Loading placeholder for {@link ModuleOutline}.
 *
 ...
 */
export const ModuleOutlineSkeleton = ({
    count,
}: ModuleOutlineSkeletonProps) => {
