...
import {
    ModuleOutlineSkeleton,
} from "./ModuleOutlineSkeleton"

/**
 * Props for {@link ModuleOutline}.
 */
type ModuleOutlineProps = WithClassNames<undefined> & {
    /** Collapsed mode: render a slim numbered index instead of the full accordion. */
    collapsed?: boolean
}

/**
 * Module navigation outline rail with a content list per module.
 *
 ...
 */
export const ModuleOutline = ({ className, collapsed = false }: ModuleOutlineProps) => {
