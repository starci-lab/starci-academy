...
export type ProfileJobReadinessProps = WithClassNames<undefined>
 ...
 * (same pattern as the other overview cards); the parent
 * {@link import("@/components/blocks").LabeledCard} supplies the frame.
 *
 * @param props - optional root class name (placement only)
 */
export const ProfileJobReadiness = ({ className }: ProfileJobReadinessProps) => {
