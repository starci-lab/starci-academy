...
import type { HeadhuntingsLearnBreadcrumbItem } from "../types"

/**
 * Builds the breadcrumb trail for the learn headhuntings list page.
 * Reads the active course from Redux and wires navigation handlers.
 * @returns Ordered breadcrumb rows for the page.
 */
export const useHeadhuntingsBreadcrumbs = (): Array<HeadhuntingsLearnBreadcrumbItem> => {
    ...
    return useMemo((): Array<HeadhuntingsLearnBreadcrumbItem> => [
        {
            key: "home",
            label: t("nav.home"),
