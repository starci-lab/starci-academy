        ...
        >
            ...
            <div className="flex flex-col items-start text-left">
                ...
                <motion.div
                    ...
                    className="flex items-center gap-1.5 text-accent mb-6 rounded-full border border-accent/20 bg-accent/5 px-3 py-1"
                >
                ...
                >
                    <a
                        href="#courses"
                        className="group flex items-center justify-center gap-1.5 px-7 py-3 rounded-full bg-accent text-accent-foreground font-semibold shadow-lg shadow-accent/20 hover:gap-3 hover:shadow-accent/30 transition-all"
                    >
                        {t("ctaRoadmap")}
                        <ArrowRight />
                    </a>
                    <a
                        href="#manifesto"
                        className="flex items-center justify-center gap-1.5 px-7 py-3 rounded-full border border-border text-foreground font-medium hover:border-accent/50 hover:bg-accent/5 transition-all"
                    >
                        {t("ctaFounder")}
                    </a>
                </motion.div>
            ...
            >
                ...
                <div className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-transparent backdrop-blur-sm p-5 shadow-2xl">
                    ...
                    <div className="mt-5 flex justify-center">
                        <div className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-accent/30 bg-accent/10 text-accent text-sm font-medium">
