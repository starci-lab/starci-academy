 ...
 *
 * ONE tree (`spine`), threaded with `isSkeleton`, wrapped in `AsyncContent` for the
 * loading/empty/error branches. `ContentModeNav` is the one exception — static chrome the
