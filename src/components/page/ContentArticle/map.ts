...
import type { ContentCommentNode, ContentReactionCount, ContentReactionType } from "./component"
 ...
 * `"early_bird"`) — so a plain cast is either unsafe or wrong, and each needs its
 * own tiny mapping function instead.
 */
