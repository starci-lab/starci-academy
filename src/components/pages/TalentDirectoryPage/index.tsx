...
import { _TalentDirectoryPage } from "./component"
 ...
 * {@link _TalentDirectoryPage}. See `design/storybook/architecture/split.md`.
 */
export const TalentDirectoryPage = () => {
