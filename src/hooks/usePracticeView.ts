...
/** The two top-level PracticeHubPage views, mirrored to the `?view=` URL param. */
export type PracticeView = "problems" | "leaderboard"

/** Query key the active view is mirrored to (`/PracticeHubPage?view=leaderboard`). */
const VIEW_KEY = "view"
...
/**
 * Read/write the top-level PracticeHubPage view (Problems ⇄ Leaderboard) through the URL
