...
import type { QuizCardEntity } from "./quiz-card"
import type { ChallengeDifficulty } from "../enums/challenge-difficulty"

/**
 * Quizlet-style interview-prep deck owned by a course. Mirrors table `quiz_decks`.
 */
export interface QuizDeckEntity extends AbstractEntity {
    /** Deck title. */
    title: string
    ...
    /** Multiple-choice cards belonging to this deck. */
