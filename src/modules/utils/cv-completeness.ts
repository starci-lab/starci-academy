/**
 * A lightweight "how complete is this CvGalleryPage" scorer for the sidebar meter — a
...
import type { CvBlock, CvDocument } from "@/modules/types/entities/cv"
...
/**
 * Scores a CvGalleryPage draft's completeness (0..100) and surfaces the highest-weighted
 * MISSING item as a one-line nudge — cheap, derived purely from `doc.blocks`.
 *
 * @param doc - the CvGalleryPage draft to score.
